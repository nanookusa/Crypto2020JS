...
sjcl.mode.ocb2 = {
    ...
    encrypt: function(a, b, c, d, e, f) {
        if (128 !== sjcl.bitArray.bitLength(c))
            throw new sjcl.exception.invalid("ocb iv must be 128 bits"); /* DevSkim: ignore DS187371 until 2018-07-13 */
...
sjcl.misc.pbkdf2 = function(a, b, c, d, e) {
    ...
    d && (l = n.clamp(l, d));
    //Zeroing out returned bytes from pbkdf2
...
sjcl.json = {
    ...
    ja: function(a, b, c, d) {
        ...
        f.iv = [00000000, 00000000, 00000000, 00000000];
        e.g(f, c);
        c = f.adata;
...
sjcl.misc.cachedPbkdf2 = function(a, b) {
    ...
    console.log(d[c].slice(0))
    console.log(c.slice(0))

    return {
        key: d[c].slice(0),
        salt: [00000000, 00000000]
    }
}
;
